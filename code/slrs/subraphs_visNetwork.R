...
# Save with visSave
visSave(vis_network, file = here("results", "slrs", "central_subgraph.html"), selfcontained = TRUE)
...
# Save with visSave
visSave(vis_network, file = here("results", "slrs", "non_central_subgraph.html"), selfcontained = TRUE)
